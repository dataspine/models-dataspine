...
def main(unused_argv):
  ...
  #run_config=tf.estimator.RunConfig(model_dir=os.path.join(os.environ['DATASPINE_OUTPUT_PATH'],
...
class MNISTArgParser(argparse.ArgumentParser):
  ...
  def __init__(self):
    ...
    self.add_argument(
        '--data_dir',
        type=str,
        default=os.environ['DATASPINE_INPUT_PATH'],
    ...
    self.add_argument(
        '--export_dir',
        type=str,
        default='%s/dataspine_tfserving/0' % os.environ['DATASPINE_OUTPUT_PATH'],
